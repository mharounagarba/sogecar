...
import './AssuresTable.css'

export default function AssuresTable({
      ...
      <table className="material-table">
        <thead>
          <tr>
            ...
            <th onClick={() => toggleSort('sitFamille')}>Situation {sortArrow('sitFamille')}</th>
                ...
                <div className="dropdown-wrapper" ref={el => dropdownRefs.current[a.id] = el}>
                  ...
                  {dropdownOpenId === a.id && (
                    <div className={`dropdown-menu ${dropdownDirection === 'top' ? 'top' : ''}`}>
                      <button onClick={() => navigate(`/assures/${a.id}/update`)}><FaPen /> Modifier</button>
